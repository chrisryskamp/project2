...
var request = require("../routes/apiRoutes")


test("should generate table", () => {
  expect(new db.Cards()).toHaveProperty('question');
  expect(new db.Cards()).toHaveProperty('hint');
  expect(new db.Cards()).toHaveProperty('answer');
});

//Not specific enough
test("should pull data from cards table", () => {
